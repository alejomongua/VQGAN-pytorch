            ...
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    ...
                    perceptual_rec_loss = args.perceptual_loss_factor * \
                        perceptual_loss + args.rec_loss_factor * rec_loss
                    ...
                    if i % 10 == 0:
                        with torch.no_grad():
                            ...
                            vutils.save_image(real_fake_images, os.path.join(
                                "results", f"{epoch}_{i}.jpg"), nrow=4)
                    ...
                    pbar.update(0)
                torch.save(self.vqgan.state_dict(), os.path.join(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-codebook-vectors', type=int, default=256,
    ...
    parser.add_argument('--image-channels', type=int, default=1,
                        help='Number of channels of images (default: 1)')
    parser.add_argument('--dataset-path', type=str,
                        default='/data', help='Path to data (default: /data)')
    ...
    parser.add_argument('--learning-rate', type=float,
                        default=2.25e-05, help='Learning rate (default: 0.0002)')
    parser.add_argument('--beta1', type=float, default=0.5,
                        help='Adam beta param (default: 0.0)')
    parser.add_argument('--beta2', type=float, default=0.9,
                        help='Adam beta param (default: 0.999)')
    ...
    parser.add_argument('--perceptual-loss-factor', type=float,
                        default=1., help='Weighting factor for perceptual loss.')
